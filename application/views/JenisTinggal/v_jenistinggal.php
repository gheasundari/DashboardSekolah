...
<div class="container-fluid">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h4 class="text-themecolor">Jenis Tinggal</h4>
		</div>
		<div class="col-md-7 align-self-center text-right">
			<div class="d-flex justify-content-end align-items-center">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Jenis Tinggal</li>
				</ol>
			</div>
		</div>
	</div>
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<select class="select2 form-control custom-select" style="width: 90%; height:36px;" name='tahun' onchange="updateChart(this)">
					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<h5 class="mb-3">JUMLAH SISWA BERDASARKAN AGAMA</h5>
							<h6 class=" mb-3"> TAHUN <span class="text-tahun">2022</span></h6>
							<canvas id="jenistinggal"></canvas>
						</div>
						<div class="col-lg-6 col-md-12">
							<h5 class="mb-3">PERSENTASE SISWA BERDASARKAN AGAMA</h5>
							<h6 class=" mb-3"> TAHUN <span class="text-tahun">2022</span></h6>
							<center>
								<canvas id="jenistinggal_pie"></canvas>
							</center>
						</div>
					</div>
				</div>
...
<script>
	jQuery(document).ready(function() {
		...
		$.ajax({
			url: baseUrl + 'C_JenisTinggal/countSiswa/<?= $tahunterakhir->tahun ?>',
			dataType: 'json',
			method: 'get',
			success: data => {
