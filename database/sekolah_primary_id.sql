...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Agu 2022 pada 14.19
...
CREATE TABLE `fact_sekolah` (
  `id_fact_sekolah` int(11) NOT NULL,
...
CREATE TABLE `xls_sekolah` (
  `id_xls_sekolah` int(11) NOT NULL,
...
ALTER TABLE `fact_sekolah`
  ADD PRIMARY KEY (`id_fact_sekolah`),
  ADD KEY `agama` (`agama`),
...
ALTER TABLE `xls_sekolah`
  ADD PRIMARY KEY (`id_xls_sekolah`);

--
-- Indeks untuk tabel `xl_sekolah`
--
ALTER TABLE `xl_sekolah`
  ADD PRIMARY KEY (`id_xl_sekolah`);
...
--
-- AUTO_INCREMENT untuk tabel `fact_sekolah`
--
ALTER TABLE `fact_sekolah`
  MODIFY `id_fact_sekolah` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `xls_sekolah`
--
ALTER TABLE `xls_sekolah`
  MODIFY `id_xls_sekolah` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `xl_sekolah`
--
ALTER TABLE `xl_sekolah`
  MODIFY `id_xl_sekolah` int(11) NOT NULL AUTO_INCREMENT;
